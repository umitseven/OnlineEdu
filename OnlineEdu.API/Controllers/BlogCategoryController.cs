...
namespace OnlineEdu.API.Controllers
{
    ...
    public class BlogCategoryController(IGenericService<BlogCategory> _blogCategoryService, IMapper _mapper) : ControllerBase
    {
        ...
        {
            var values = _mapper.Map<BlogCategory>(createBlogCategoryDto);
            _blogCategoryService.TCreate(values);
            return Ok("Yeni Blog Kategorisi Oluşturuldu");
        }
        [HttpPut]
        public IActionResult Update(UpdateBlogCategoryDto updateBlogCategoryDto)
        {
            ...
            return Ok("Blog Kategorileri başarılı bir şekilde güncellendi");
        }
    }
}
